...
<div class="mb-8">
    ...
    <h1 class="text-2xl font-bold text-slate-800">Buat Tiket Baru</h1>
    <p class="text-slate-600 mt-1">Isi form di bawah untuk membuat tiket baru.</p>
</div>
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sm:p-8">
    <form action="{{ route('tickets.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex flex-wrap gap-3 pt-2">
            ...
            <a href="{{ route('tickets.index') }}" class="inline-flex items-center px-5 py-2.5 bg-white border border-slate-300 text-slate-700 rounded-lg font-medium hover:bg-slate-50 transition">
                Batal
            </a>
        </div>
    </form>
